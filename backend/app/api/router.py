...
from app.api.v1 import admin, auth, circle, event, feedback, health, im, map, network, notification, payment, points, post, product_safety, settlement, user, verification
...
api_router.include_router(product_safety.router)
